...
<div class="container-fluid">
    ...
    <form action="/addChallenge" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" name="ChallName" required="required" id="inputName">
        </div>
        <div class="form-group col-md-6">
            <label for="inputName">Hint</label>
            <input type="text" class="form-control" name="hint" required="required" id="inputName">
        </div>
