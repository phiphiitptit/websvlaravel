                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><a class="btn btn-sm btn-outline-success" href="/useraddMessage/{{$user[0]->id}}">Nhắn tin</a></th>
                            </tr>
                        </thead>
                        <tbody>
                            <div class="table-responsive">
                                <table class="table table-striped table-sm" style="text-align: center;">
                                    ...
                                    @endif
                                    <thead>
                                        <form action="/userEditMessage/{{$user[0]->id}}" method="post">
                                            {{ csrf_field() }}
