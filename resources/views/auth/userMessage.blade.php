                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-info" name="seenmes" href="userViewMessage/{{$d->id}}">
                                        Xem</a>
                                    <a class="btn btn-info" name="edit" href="userEditMessage/{{$d->id}}">
                                        Sửa</a>
                                    <a class="btn btn-info btn-danger" name="delete" href="userDeleteMessage/{{$d->id}}">
                                        Xóa</a>
                                </td>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a class="btn btn-info" name="seenmes" href="userViewMessage/{{$d->id}}">
                                    ...
                                    <a class="btn btn-info" name="checkseen" href="userSeenMessage/{{$d->id}}">
                                        Đã xem</a>
                                </td>
